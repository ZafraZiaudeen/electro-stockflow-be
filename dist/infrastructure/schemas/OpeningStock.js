...
const openingStockSchema = new mongoose_1.default.Schema({
    partNumber: {
        type: String,
...
const OpeningStock = mongoose_1.default.model("OpeningStock", openingStockSchema);
exports.default = OpeningStock;
